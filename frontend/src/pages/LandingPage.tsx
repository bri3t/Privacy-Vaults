        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-[var(--text-primary)] mb-2">TEE Openfort Wallets</h3>
              <p className="text-sm text-[var(--text-tertiary)] leading-relaxed">
                Full UX friendly experience for non-crypto familiar users. Gasless transactions, no seed phrases, no complexity.
              </p>
            </motion.div>
